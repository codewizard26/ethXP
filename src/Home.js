    ...
    <div className="bg-gray-900 min-h-screen flex items-center justify-center text-white">
      <div className="flex-1 p-36">
        ...
        <p className="text-lg mb-8 ">
          Welcome to our platform where you can upload and manage your research
          papers in a completely decentralized way no hustle of waiting for so
          long to get your work published and verified with the power of
          blockchain to own and ai to check uniqueness and relations.
        </p>
